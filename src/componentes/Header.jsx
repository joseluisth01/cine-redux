            ...
            <nav className="bg-neutral-900 border-gray-200 px-4 lg:px-6 py-5">
                <div className="flex flex-wrap justify-between items-center mx-auto ">
                    ...
                    <div className="flex items-center lg:order-2 mr-7">
                        <a href="#" className="text-white dark:text-white hover:bg-[#2e3646] focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"><img className='usuario' src="../../public/img/usuario.png" /></a>
                    </div>
